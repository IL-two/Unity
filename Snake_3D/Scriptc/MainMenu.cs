...
public class MainMenu : MonoBehaviour {
	...
	public string cleartButtonText = "Clear results";
    ...
    public void OnGUI()
    {
        ...
        GUILayout.BeginArea(rect, GUI.skin.textArea);
        {
			...
			// динамическое пространство между кнопками

			if (GUILayout.Button(cleartButtonText, buttonStyle, GUILayout.MinHeight(buttonMinHeight)))
			{
				// загрузка сцены с именем Level
